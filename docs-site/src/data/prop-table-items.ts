...
const componentPropTypes: Record<string, Record<string, string>> = {
  Box: {
    ...
    maxHeight: 'MossyBoxLength | undefined',
    maxWidth: 'MossyBoxLength | undefined',
    minHeight: 'MossyBoxLength | undefined',
    minWidth: 'MossyBoxLength | undefined',
  ...
  Flex: {
    ...
    justifyContent:
      '"flex-start" | "flex-end" | "center" | "space-between" | "space-around" | "flexStart" | "flexEnd" | "spaceBetween" | "spaceAround" | undefined',
    maxHeight: 'MossyFlexSizeConstraint | undefined',
    maxWidth: 'MossyFlexSizeConstraint | undefined',
    minHeight: 'MossyFlexSizeConstraint | undefined',
    minWidth: 'MossyFlexSizeConstraint | undefined',
    p: 'MossyBoxPadding | undefined',
    padding: 'MossyBoxPadding | undefined',
    paddingBottom: 'MossyBoxPadding | undefined',
    paddingLeft: 'MossyBoxPadding | undefined',
  ...
  Grid: {
    ...
    boxShadow: 'MossyBoxShadow | undefined',
    children: 'ReactNode | undefined',
    colEnd: 'MossyGridItemLine | undefined',
    columns: 'MossyGridTrackCount | undefined',
    colSpan: 'MossyGridItemSpan | undefined',
    colStart: 'MossyGridItemLine | undefined',
