...
const componentPropTypes: Record<string, Record<string, string>> = {
  Box: {
    ...
    flexGrow: 'MossyBoxFlexGrow | undefined',
  ...
  Grid: {
    ...
    boxShadow: 'MossyBoxShadow | undefined',
    children: 'ReactNode | undefined',
    columns: 'MossyGridTrackCount | undefined',
    display: 'MossyGridDisplay | undefined',
    flexGrow: 'MossyBoxFlexGrow | undefined',
    gap: 'MossyBoxPadding | undefined',
    height: 'MossyBoxLength | undefined',
    maxHeight: 'MossyGridSizeConstraint | undefined',
    maxWidth: 'MossyGridSizeConstraint | undefined',
    minHeight: 'MossyGridSizeConstraint | undefined',
    minWidth: 'MossyGridSizeConstraint | undefined',
    p: 'MossyBoxPadding | undefined',
    padding: 'MossyBoxPadding | undefined',
    paddingBottom: 'MossyBoxPadding | undefined',
    paddingLeft: 'MossyBoxPadding | undefined',
  ...
  HStack: {
    ...
    justifyContent:
      '"flex-start" | "flex-end" | "center" | "space-between" | "space-around" | "flexStart" | "flexEnd" | "spaceBetween" | "spaceAround" | undefined',
    maxHeight: 'MossyHStackSizeConstraint | undefined',
    maxWidth: 'MossyHStackSizeConstraint | undefined',
    minHeight: 'MossyHStackSizeConstraint | undefined',
    minWidth: 'MossyHStackSizeConstraint | undefined',
    p: 'MossyBoxPadding | undefined',
    padding: 'MossyBoxPadding | undefined',
    paddingBottom: 'MossyBoxPadding | undefined',
    paddingLeft: 'MossyBoxPadding | undefined',
